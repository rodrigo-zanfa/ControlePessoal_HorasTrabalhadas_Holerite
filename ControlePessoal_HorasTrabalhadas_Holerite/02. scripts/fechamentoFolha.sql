...
declare @DataInicial date = '2021-09-13'
declare @DataFinal date = '2021-09-14'
...
/* 01. Quantidade de Dependentes                                                                                                                                                  */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ */

exec dbo.RetornarParametroDoUsuario 6, @IdUsuario, @DataFinal, @Valor output
print '@Valor = ' + @Valor

declare @QuantidadeDependentes int = cast(@Valor as int)
print '@QuantidadeDependentes = ' + cast(@QuantidadeDependentes as varchar)


/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* preparação para retornar os parâmetros necessários para cálculos                                                                                                               */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ */

declare @Salario numeric(8,2) = 0
exec dbo.RetornarSalarioDoUsuario @IdUsuario, @DataFinal, @Salario output
print '@Salario = ' + cast(@Salario as varchar)

declare @ValorInss numeric(8,2) = 0
exec dbo.RetornarValorInssDoSalario @DataFinal, @Salario, @ValorInss output
print '@ValorInss = ' + cast(@ValorInss as varchar)

--declare @SalarioMinimo numeric(8,2) = 0
--exec dbo.RetornarSalarioMinimo @DataFinal, @SalarioMinimo output
--print '@SalarioMinimo = ' + cast(@SalarioMinimo as varchar)

declare @ValorIrrf numeric(8,2) = 0
exec dbo.RetornarValorIrrfDoSalario @DataFinal, @Salario, @ValorInss, @QuantidadeDependentes, @ValorIrrf output
print '@ValorIrrf = ' + cast(@ValorIrrf as varchar)
