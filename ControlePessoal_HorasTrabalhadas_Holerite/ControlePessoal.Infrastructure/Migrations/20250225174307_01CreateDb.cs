        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataHoraInclusao = table.Column<DateTime>(type: "datetime", nullable: false, defaultValue: new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
            ...
            migrationBuilder.InsertData(
                table: "APIUsuario",
                columns: new[] { "IdUsuario", "DataHoraAlteracao", "DataHoraInclusao", "Nome" },
                values: new object[] { 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "RODRIGO ZANFERRARI CARAÇA" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, null, "Quantidade de Dependentes", "Quantidade de Dependentes que o Usuário possui, para fins de desconto do cálculo de IRRF", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, null, new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, 1, "2" }
                });
