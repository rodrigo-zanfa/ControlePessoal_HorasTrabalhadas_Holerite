...
{
    public class CreateAusenciaCommand : Notifiable<Notification>, ICommand
    {
        public CreateAusenciaCommand(int idUsuario, DateTime dataAusencia, TimeSpan horaInicialAusencia, TimeSpan horaFinalAusencia)
        {
            IdUsuario = idUsuario;
        ...
        {
            AddNotifications(new Contract<CreateAusenciaCommand>()
                .Requires()
